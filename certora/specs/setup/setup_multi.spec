// Main setup file for multi positions support

import "./licredity/licredity.spec";     
import "./licredity/storage_hooks_position_multi.spec";
import "./licredity/types/position_multi.spec";
import "./licredity/libraries/locker_multi.spec";

import "./erc20_cvl.spec";
import "./erc721_cvl.spec";
