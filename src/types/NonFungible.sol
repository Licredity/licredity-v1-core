...
// TODO: remove if removeNonFungible turned to assembly
/// @notice Checks whether two non-fungibles are equal
/// @param x The first non-fungible to compare
/// @param y The second non-fungible to compare
